install:
	install -p -D -m 0755 add_user.sh /var/scripts/add_user.sh
	install -p -D -m 0755 del_user.sh /var/scripts/del_user.sh
	install -p -D -m 0755 reset_user.sh /var/scripts/reset_user.sh
